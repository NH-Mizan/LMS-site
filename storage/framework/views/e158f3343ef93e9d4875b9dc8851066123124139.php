...
<?php $__env->startSection('title','Store Create'); ?>
...
<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <a href="<?php echo e(route('seller.store.index')); ?>" class="btn btn-primary rounded-pill">Manage</a>
                </div>
   ...
   <div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('seller.store.store')); ?>" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data" name="editForm">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?> " name="cover_photo"  value="<?php echo e(old('cover_photo')); ?>"  id="cover_photo">
...
unset($__errorArgs, $__bag); ?> " name="logo"  value="<?php echo e(old('logo')); ?>"  id="logo">
...
unset($__errorArgs, $__bag); ?>" name="whatsapp" value="<?php echo e(old('whatsapp')); ?>" id="whatsapp" required="">
...
<script type="text/javascript">
     ...
     function add_more_customer_choice_option(i, name){
        $.ajax({
            ...
            type:"POST",
             url: "<?php echo e(url('editor/product/add-more-choice-option')); ?>",
            data:{
               attribute_id: i
            },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontEnd.seller.pages.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\pikarihut1\resources\views/backEnd/sellerStore/create.blade.php ENDPATH**/ ?>