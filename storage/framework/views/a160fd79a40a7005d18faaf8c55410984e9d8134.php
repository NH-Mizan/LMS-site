...
<?php $__env->startSection('title','Pending Product'); ?>
        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <a href="<?php echo e(route('products.create')); ?>" class="btn btn-primary rounded-pill">Create</a>
                </div>
                ...
                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e(Str::limit($value->name,30)); ?></td>
                            ...
                            <td>
                                <div class="button-list">
                                    ...
                                    <?php if($value->proCode !=NULL && $value->proCommission !=NULL): ?>
                                    <form method="post" action="<?php echo e(route('sellers.product_approve')); ?>" class="d-inline"> 
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <a href="<?php echo e(route('products.procode.edit',$value->id)); ?>" title="Approve" class="btn btn-xs btn-success waves-effect waves-light"><i class="fe-check"></i></a>
                                    <?php endif; ?>

                                    <a href="<?php echo e(route('products.edit',$value->id)); ?>" class="btn btn-xs btn-primary waves-effect waves-light"><i class="fe-edit-1"></i></a>
...
<!-- third party js ends -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\pikarihut1\resources\views/backEnd/seller/pending_product.blade.php ENDPATH**/ ?>