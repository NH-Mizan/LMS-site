...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div>
                                                            <p><b>Status :</b>
                                                                <?php if($details->stock > 0): ?>
                                                                    <span style="color:green;font-weight:bold">In
                                                                        Stock</span>
                                                                <?php else: ?>
                                                                    <span style="color:red;font-weight:bold">Out
                                                                        Stock</span>
                                                                <?php endif; ?>
                                                            </p>
                                                        </div>
                                                        ...
                                                        <?php 
                                                        $seller = App\Models\Seller::where('id',$details->seller_id)->where('status','active')->first();
                                                        ?>
                                                        <?php if($seller): ?>
                                                        <div class="store__parts__section mt-4">
                                                            <div class="store__part1">
                                                               <p>Sold by</p>
                                                               <h4><?php echo e($seller->name); ?></h4>
                                                            </div>
                                                            <div class="store__part2">
                                                                <div class="chat__now__seller"><a href="https://api.whatsapp.com/send?phone=88<?php echo e($seller->phone); ?>"><i class="fa-brands fa-rocketchat"></i> Chat Now</a></div>
                                                            </div>
                                                            <div class="store__part3">
                                                                <a href="<?php echo e(route('seller.stores',$seller->slug)); ?>">GO TO STORE</a>
                                                            </div>
                                                        </div>
                                                        <?php endif; ?>
                                                </form>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8">
                  ...
                  <div class="section-head">
                    <div class="title">
                      <p class="count__question">Questions (<?php echo e($question->count()); ?>)</p>
                      <p>Have question about this product? Get specific details about this product from expert.</p>
                    </div>
                    <div class="action">
                      <div>
                        <button type="button" class="details-action-btn question-btn btn-overlay" data-bs-toggle="modal" data-bs-target="#staticBackdrop1">
                          Ask Question
                        </button>
                      </div>
                    </div>
                  ...
                  <!---->
                   <?php if($question->count() > 0): ?>
                    <div class="customer-review">
                        <div class="row">
                            <?php $__currentLoopData = $question; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $que): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-sm-12 col-12">
                                    <div class="review-card">
                                        <p class="reviewer_name"><i class="fa-solid fa-file-circle-question"></i>
                                            <?php echo e($que->name); ?></p>
                                        <p class="review_data"><?php echo e($que->created_at->format('d-m-Y')); ?></p>
                                        
                                        <p class="review_content"><?php echo e($que->question); ?></p>
                                    </div>
                                </div>
                          <?php if($que->answer !== null): ?>
                            ...
                            <div class="col-sm-11 col-11">
                                <div class="question-card">
                                        ...
                                        <p class="review_content"><?php echo e($que->answer); ?></p>
                                </div>
                            </div>
                            <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="empty-content">
                        <i class="fa fa-clipboard-list"></i>
                        <p class="empty-text">This product has no question yet. Be the first one to write a question.</p>
                    </div>
                    <?php endif; ?>
                  <!---->
                   <div class="modal fade" id="staticBackdrop1" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          <div class="modal-header">
                            <p class="modal-title fs-5" id="staticBackdropLabel">Your question</p>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                          </div>
                          <div class="modal-body">
                           <div class="insert-review">
                                    <?php if(Auth::guard('customer')->user()): ?>
                                    <form action="<?php echo e(route('customer.question')); ?>" id="review-form" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="product_id" value="<?php echo e($details->id); ?>">
                                        <input type="hidden" name="seller_id" value="<?php echo e($details->seller_id); ?>">

                                        <div class="form-group">
                                            <label for="message-text" class="col-form-label">Question:</label>
                                            <textarea required class="form-control radius-lg" name="question" id="message-text"></textarea>
                                            <span id="validation-message" style="color: red;"></span>
                                        </div>
                                        <div class="form-group">
                                            <button class="details-review-button" type="submit">Submit Question</button>
                                        </div>

                                    </form>
                                    <?php else: ?>
                                    <a class="customer-login-redirect" href="<?php echo e(route('customer.login')); ?>">Login to Post Your Question</a>
                                    <?php endif; ?>
                                </div>
                          </div>
                        </div>
...
$message = $__bag->first($__errorArgs[0]); ?>
    ...
    <script>
    function sendSuccess() {
        let colorSelected = document.querySelector('input[name="product_color"]:checked');
        let sizeSelected = document.querySelector('input[name="product_size"]:checked');
        let showColorError = false;
        ...
        if (document.querySelectorAll('input[name="product_color"]').length > 0 && !colorSelected) {
            const errorDiv = document.createElement('div');
            errorDiv.className = "mt-1 text-danger validation-error";
            errorDiv.innerHTML = 'Please select a color <i class="fa-solid fa-arrow-up text-danger me-1"></i>';
            const colorSection = document.querySelector('.pro-color');
            colorSection.parentNode.insertBefore(errorDiv, colorSection.nextSibling);
            showColorError = true;
        }

        // Check size selection
        if (document.querySelectorAll('input[name="product_size"]').length > 0 && !sizeSelected) {
            const errorDiv = document.createElement('div');
            errorDiv.className = "mt-1 text-danger validation-error";
            errorDiv.innerHTML = 'Please select a size <i class="fa-solid fa-arrow-up text-danger me-1"></i> ';
            const sizeSection = document.querySelector('.pro-size');
            sizeSection.parentNode.insertBefore(errorDiv, sizeSection.nextSibling);
            showSizeError = true;
        }

        return !(showColorError || showSizeError);
    }
</script>

<?php $__env->stopPush(); ?>

<?php echo $__env->make('frontEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\pikarihut1\resources\views/frontEnd/layouts/pages/details.blade.php ENDPATH**/ ?>