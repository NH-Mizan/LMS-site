...
<?php $__env->startSection('content'); ?>
    ...
    <nav class="navbar logo-area ">
      <div class="container">
        ...
        <div class="contact-info">
          <div class="phone">
            <i class="fa fa-phone"></i> <?php echo e($contact->hotline); ?>

          </div>
          <div class="email">
            <i class="fa fa-envelope"></i> <?php echo e($contact->email); ?>
  ...
  <div class="container">
    ...
    <nav class="header__area "  id="headerArea">
      ...
      <a href="<?php echo e(route('hotdeals')); ?>">Our Courses</a>
                ...
                <div class="col-sm-10 col-md-10 col-lg-8">
                    ...
                    <div class="post-corporate-gallery post-corporate-gallery-2 inset-1" data-lightgallery="group">
                        <a class="post-corporate-thumbnail post-corporate-thumbnail-1 post-corporate-thumbnail-custom"
                            ...
                            <img class="post-corporate-thumbnail-image" src="<?php echo e(asset($home_gallery1->image)); ?>" alt=""
                                width="722" height="490" /></a>
                        <a class="post-corporate-thumbnail post-corporate-thumbnail-5"
                            href="<?php echo e(asset($home_gallery2->image)); ?>" data-lightgallery="item">
                            <img class="post-corporate-thumbnail-image" src="<?php echo e(asset($home_gallery2->image)); ?>" alt=""
                                width="360" height="326" /></a>
                        <a class="post-corporate-thumbnail post-corporate-thumbnail-5"
                            href="<?php echo e(asset($home_gallery3->image)); ?>" data-lightgallery="item">
                            <img class="post-corporate-thumbnail-image" src="<?php echo e(asset($home_gallery3->image)); ?>" alt=""
                                width="360" height="326" /></a>
                    </div>
                </div>
                        ...
                        <div class="col-md-6 col-lg-12">
                            <article class="box-8 mt-30 mt-xl-60 wow fadeIn" data-wow-delay=".1s">
                                <ul class="list-pricing">
                                    <?php $__currentLoopData = $pro_courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li><a href="<?php echo e(route('product', $value->slug)); ?>"><span
                                                    class="list-pricing-title"><?php echo e($value->name); ?></span><span>$<?php echo e($value->new_price); ?></span></a>
                                        </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                            </article>
                    ...
                    <div class="col-sm-6 col-lg-4 wow fadeIn">
                        ...
                        <article class="post-classic"><a class="post-classic-figure" href="blog-post.html"><img
                            ...
                            <time class="post-classic-time" datetime="2021">
                                <p><?php echo e(\Carbon\Carbon::parse($value->created_at)->format('M d, Y')); ?></p>
                            </time>
