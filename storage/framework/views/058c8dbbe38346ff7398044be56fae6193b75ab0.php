...
<?php $__env->startSection('title','Store Manage'); ?>
        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <a href="<?php echo e(route('seller.store.create')); ?>" class="btn btn-primary rounded-pill">Create</a>
                </div>
                ...
                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span ><?php echo e($value->title); ?></span></td>
                            <td><span ><?php echo e($value->whatsapp); ?></span></td>
                            <td><img src="<?php echo e(asset($value->cover_photo)); ?>" class="backend-image" alt=""></td>
                            <td><img src="<?php echo e(asset($value->logo)); ?>" class="backend-image" alt=""></td>
                            <td>
                            ...
                            <td>
                                <div class="button-list">
                                    <?php if($value->status == 1): ?>
                                    <form method="post" action="<?php echo e(route('seller.store.inactive')); ?>" class="d-inline"> 
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <?php else: ?>
                                    <form method="post" action="<?php echo e(route('seller.store.active')); ?>" class="d-inline">
                                        <?php echo csrf_field(); ?>
                                    <input type="hidden" value="<?php echo e($value->id); ?>" name="hidden_id">        
                                    ...
                                    <a href="<?php echo e(route('seller.store.edit',$value->id)); ?>" class="btn btn-xs btn-primary waves-effect waves-light"><i class="fe-edit-1"></i></a>
...
<!-- third party js ends -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontEnd.seller.pages.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\pikarihut1\resources\views/backEnd/sellerStore/index.blade.php ENDPATH**/ ?>