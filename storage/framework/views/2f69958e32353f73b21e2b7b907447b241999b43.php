...
unset($__errorArgs, $__bag); ?>" name="pdf" value="<?php echo e($edit_data->pdf); ?>" id="pdf" />
                <a class="btn btn-success" href="<?php echo e($edit_data->pdf); ?>"></a>
                <?php $__errorArgs = ['pdf'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\pikarihut1\resources\views/backEnd/product/edit.blade.php ENDPATH**/ ?>