...
<?php $__env->startSection('content'); ?>
    <section class="hero"
        style="background: url(<?php echo e(asset('public/frontEnd/images/bg-image-4.jpg')); ?>) no-repeat center center / cover;">
            ...
            <article class="blog-layout">
                <div class="blog-layout-main">
                    <div class="blog-layout-main-item">
                        <article class="post-corporate"><img class="post-corporate-image" src="<?php echo e(asset($details->image)); ?>"
                                alt="" width="768" height="396" />
                            <ul class="post-corporate-meta">
                                <li><span class="icon mdi mdi-calendar-today"></span>
                                    <time datetime="2021"><p><?php echo e(\Carbon\Carbon::parse($details->created_at)->format('M d, Y')); ?></p></time>
                                </li>
                                <li><span class="icon mdi mdi-account"></span><span><?php echo e($details->name); ?></span></li>
                                <li><span
                                        class="icon mdi mdi-tag-outline"></span><span><?php echo e($details->category->name); ?></span>
                                </li>
                            </ul>
                ...
                <div class="blog-layout-aside">
                    ...
                    <div class="blog-layout-aside-item">
                        ...
                        <div class="group-post-minimal">
                            ...
                            <?php $__currentLoopData = $lats_blog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <article class="post-minimal"><a class="post-minimal-media" href="<?php echo e(route('blog.details', $value->slug)); ?>"><img
                                            class="post-minimal-image" src="<?php echo e(asset($value->image)); ?>" alt="" width="79"
                                            height="78" /></a>
                                    <div class="post-minimal-main">
                                        <h6 class="post-minimal-title"><a href="<?php echo e(route('blog.details', $value->slug)); ?>"><?php echo e($value->title); ?></a></h6>
                                        <time class="post-minimal-time" datetime="2021"><p><?php echo e(\Carbon\Carbon::parse($value->created_at)->format('M d, Y')); ?></p></time>
                                    </div>
                                </article>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="blog-layout-aside-item">
                        ...
                        <article class="tour-light bg-image context-dark"
                            style="background-image: url(<?php echo e(asset('public/frontEnd/images/blog-post-8.jpg')); ?>);">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\aaa\resources\views/frontEnd/layouts/pages/blog_details.blade.php ENDPATH**/ ?>