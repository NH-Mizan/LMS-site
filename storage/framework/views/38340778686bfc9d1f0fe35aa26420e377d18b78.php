...
<?php $__env->startSection('content'); ?>
        ...
        <!-- Page Header-->
    <section class="hero" style="background: url(<?php echo e(asset('public/frontEnd/images/bg-image-01.jpg')); ?>) no-repeat center center / cover;">
                                    ...
                                    <form class="rd-form rd-mailform form-lg" data-form-output="form-output-global"
                                        ...
                                        <div class="form-wrap form-wrap-icon wow fadeIn" data-wow-delay=".15s">
                                            <label class="form-label form-label-outside"
                                                for="contact-1-email">E-mail</label>
                        ...
                        <div class="inset-4">
                            <div class="layout-2 wow fadeIn">
                                ...
                                <div class="layout-2-item"><a class="button button-sm button-style-1"
                                        href="our-courses.html">See All</a></div>
                            </div>
                        ...
                        <div class="post-corporate-gallery post-corporate-gallery-2 inset-1" data-lightgallery="group">
                            <a class="post-corporate-thumbnail post-corporate-thumbnail-1 post-corporate-thumbnail-custom"
                                ...
                                <img class="post-corporate-thumbnail-image"
                                    src="<?php echo e(asset('public/frontEnd/images/group-01-722x490.jpg')); ?>" alt=""
                                    width="722" height="490" /></a>
                            <a class="post-corporate-thumbnail post-corporate-thumbnail-5"
                                href="images/group-02-original.jpg" data-lightgallery="item">
                                <img class="post-corporate-thumbnail-image"
                                    src="<?php echo e(asset('public/frontEnd/images/group-02-360x326.jpg')); ?>" alt="" width="360"
                                    height="326" /></a>
                            <a class="post-corporate-thumbnail post-corporate-thumbnail-5"
                                href="images/group-03-original.jpg" data-lightgallery="item">
                                <img class="post-corporate-thumbnail-image"
                ...
                <div class="row row-40 row-md-50 row-xxl-80">
                    <div class="col-sm-6 col-lg-4 wow fadeIn">
                        ...
                        <article class="post-classic"><a class="post-classic-figure" href="blog-post.html"><img
                                    class="post-classic-image" src="<?php echo e(asset('public/frontEnd/images/grid-blog-1-339x251.jpg')); ?>" alt="" width="339"
                                    height="251" /></a>
                            <time class="post-classic-time" datetime="2021">May 12, 2021</time>
                            <div class="post-classic-divider"></div>
                            <p class="post-classic-title fw-medium link-black"><a href="blog-post.html">7 Reasons to Study
                                    in Class Rather than Study Alone</a></p>
                        </article>
                    </div>
                    <div class="col-sm-6 col-lg-4 wow fadeIn" data-wow-delay=".05s">
                        <!-- Post Classic-->
                        <article class="post-classic"><a class="post-classic-figure" href="blog-post.html"><img
                                    class="post-classic-image" src="<?php echo e(asset('public/frontEnd/images/grid-blog-2-339x251.jpg')); ?>" alt="" width="339"
                                    height="251" /></a>
                            <time class="post-classic-time" datetime="2021">April 24, 2021</time>
                            <div class="post-classic-divider"></div>
                            <p class="post-classic-title fw-medium link-black"><a href="blog-post.html">Test of Interactive
                                    English: Personal Experience</a></p>
                        </article>
                    </div>
                    <div class="col-sm-6 col-lg-4 wow fadeIn" data-wow-delay=".1s">
                        <!-- Post Classic-->
                        <article class="post-classic"><a class="post-classic-figure" href="blog-post.html"><img
                                    class="post-classic-image" src="<?php echo e(asset('public/frontEnd/images/grid-blog-3-339x251.jpg')); ?>" alt="" width="339"
                                    height="251" /></a>
                            <time class="post-classic-time" datetime="2021">June 19, 2021</time>
                            <div class="post-classic-divider"></div>
                            <p class="post-classic-title fw-medium link-black"><a href="blog-post.html">5 Reasons Why You
                                    Should Consider Doing the FCE</a></p>
                        </article>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row row-30 row-md-50 mt-md-45 mt-xxl-70">
                            <div class="col-sm-6 col-lg-12 wow fadeIn" data-wow-delay=".05s">
                                ...
                                <article class="profile-light"><img class="profile-light-image"
                                        src="<?php echo e(asset('public/frontEnd/images/home-3-6-95x95.jpg')); ?>" alt="" width="95" height="95" />
                            ...
                            <div class="col-sm-6 col-lg-12 wow fadeIn" data-wow-delay=".1s">
                                <!-- Profile Light-->
                                <article class="profile-light"><img class="profile-light-image"
                                        src="<?php echo e(asset('public/frontEnd/images/home-3-7-95x95.jpg')); ?>" alt="" width="95" height="95" />
                                    <div class="profile-light-main">
...
<?php $__env->stopSection(); ?>
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make('frontEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abokaash/public_html/onlinehab/resources/views/frontEnd/layouts/pages/index.blade.php ENDPATH**/ ?>