                    ...
                    <form action="<?php echo e(route('customer.ordersave')); ?>" method="POST" data-parsley-validate="">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h6>To confirm your order, please fill in the information and click the "Place Order" button </h6>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="radio_payment">
                                            <label id="payment_method">Payment Option (optional)</label>
...
<?php echo $__env->make('frontEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/flexzzyc/public_html/resources/views/frontEnd/layouts/customer/checkout.blade.php ENDPATH**/ ?>