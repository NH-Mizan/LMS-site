...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('public/frontEnd/css/fonts.css')); ?>" />
...
<body>
        ...
        <div class="container">
          <div class="footer-classic-layout justify-content-sm-around justify-content-md-between divider-4">
            <div class="footer-classic-layout-item"><a class="brand" href="index.html"><img class="brand-logo-dark"
                  src="<?php echo e(asset($generalsetting->dark_logo)); ?>" alt="" width="110" height="39" /><img class="brand-logo-light"
                  src="<?php echo e(asset($generalsetting->dark_logo)); ?>" alt="" width="110" height="39" /></a>
            ...
            <div class="footer-classic-layout-item">
              ...
              <div class="footer-classic-item-block footer-classic-item-block-3">
                <ul class="list-pricing">
                  ...
                  <li><a href="<?php echo e(route('product', $value->slug)); ?>"><span class="list-pricing-title"><?php echo e($value->name); ?></span><span>$<?php echo e($value->new_price); ?></span></a></li>
  ...
  <script src="<?php echo e(asset('public/frontEnd/js/core.min.js')); ?>"></script>
  <script>
    new WOW().init();
  </script>
...
</html><?php /**PATH D:\Xampp\htdocs\aaa\resources\views/frontEnd/layouts/master.blade.php ENDPATH**/ ?>