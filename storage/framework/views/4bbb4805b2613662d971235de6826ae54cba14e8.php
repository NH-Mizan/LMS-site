...
<head>
        ...
        <!-- custom css -->
        <link href="<?php echo e(asset('public/backEnd/')); ?>/assets/css/custom.css?v=1.0.1'" rel="stylesheet" type="text/css" />
		<!-- Head js -->
                ...
                <div class="container-fluid">
                    <ul class="list-unstyled topnav-menu float-end mb-0">
                        ...
                        <li class="dropdown d-none d-lg-inline-block">
                            ...
                            <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                <img src="<?php echo e(asset(Auth::guard('seller')->user()->image)); ?>" alt="user-image" class="rounded-circle">
                                <span class="pro-user-name ms-1">
                                    <?php echo e(Auth::guard('seller')->user()->name); ?> <i class="mdi mdi-chevron-down"></i> 
                                </span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-end profile-dropdown ">
                                ...
                                <!-- item-->
                                <a href="<?php echo e(route('seller.change_pass')); ?>" class="dropdown-item notify-item">
                                ...
                                <form id="logout-form" action="<?php echo e(route('seller.logout')); ?>" method="POST" style="display: none;">
                                        <?php echo csrf_field(); ?>
                                </form>
                    ...
                    <div class="logo-box">
                        <a href="<?php echo e(url('admin/dashboard')); ?>" class="logo logo-dark text-center">
                            ...
                            <span class="logo-lg">
                                <img src="<?php echo e(asset($generalsetting->dark_logo)); ?>" alt="" height="20">
                                <!-- <span class="logo-lg-text-light">U</span> -->
                            </span>
                        </a>
    
                        <a href="<?php echo e(route('seller.account')); ?>" class="logo logo-light text-center">
                            <span class="logo-sm">
                                <img src="<?php echo e(asset($generalsetting->white_logo)); ?>" alt="" height="22">
                            </span>
                            <span class="logo-lg">
                                <img src="<?php echo e(asset($generalsetting->white_logo)); ?>" alt="" height="20">
                            </span>
                        </a>
                    </div>
                    ...
                    <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                        ...
                        <li class="dropdown d-none d-xl-block">
                            ...
                            <a class="nav-link dropdown-toggle waves-effect waves-light" 
                               target="_blank" href="<?php echo e(route('seller.stores', Auth::guard('seller')->user()->slug)); ?>">
            ...
            <div class="left-side-menu">
                ...
                <div class="h-100" data-simplebar>
                    ...
                    <div class="user-box text-center">
                        <img src="<?php echo e(asset(Auth::guard('seller')->user()->image)); ?>" alt="user-img" title="Mat Helme"
                            class="rounded-circle avatar-md">
                        <div class="dropdown">
                            <a href="javascript: void(0);" class="text-dark dropdown-toggle h5 mt-2 mb-1 d-block"
                                data-bs-toggle="dropdown"><?php echo e(Auth::guard('seller')->user()->name); ?></a>
                            <div class="dropdown-menu user-pro-dropdown">
                                <!-- item-->
                                <a href="<?php echo e(route('seller.account')); ?>" class="dropdown-item notify-item">
                    ...
                    <div id="sidebar-menu">
                        <ul id="side-menu">
                            <li>
                                <a href="<?php echo e(route('seller.account')); ?>" data-bs-toggle="collapse">
                            ...
                            <li>
                                ...
                                <div class="collapse" id="sidebar-orders">
                                    <ul class="nav-second-level">
                                        <?php $__currentLoopData = $orderstatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ordertype): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <a href="<?php echo e(route('seller.orders',['slug'=>$ordertype->slug])); ?>"><i data-feather="file-plus"></i><?php echo e($ordertype->name); ?></a>
                                        </li>
                            ...
                            <li>
                                ...
                                <div class="collapse" id="siebar-product">
                                    <ul class="nav-second-level">
                                        ...
                                        <?php else: ?>
                                        <li>
                                            <a href="<?php echo e(route('seller.products.index')); ?>">Products Manage</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('seller.products.create')); ?>">New Products</a>
                                        </li>
                                        <?php endif; ?>
                                    </ul>
                                </div>
                            ...
                            <li>
                                ...
                                <div class="collapse" id="siebar-Review">
                                    <ul class="nav-second-level">
                                        <li>
                                            <a href="<?php echo e(route('seller.reviews.index')); ?>">Manage</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('seller.reviews.create')); ?>">Add</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <!-- quetion -->
                             <li>
                                ...
                                <div class="collapse" id="siebar-question">
                                    <ul class="nav-second-level">
                                        <li>
                                            <a href="<?php echo e(route('seller.question.index')); ?>">Manage</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li>
                                ...
                                <div class="collapse" id="setting-product">
                                    <ul class="nav-second-level">
                                        ...
                                        <li>
                                            <a href="<?php echo e(route('seller.profile_edit')); ?>">Profile Update</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('seller.change_pass')); ?>">Change Password</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                             <li>
                                ...
                                <div class="collapse" id="setting-store">
                                    <ul class="nav-second-level">
                                        ...
                                        <?php if($data > 0): ?>
                                        <li>
                                            <a target="_blank" href="<?php echo e(route('seller.stores', Auth::guard('seller')->user()->slug)); ?>">My Store</a>
                                        </li>
                                        <?php endif; ?>
                                        <li>
                                            <a href="<?php echo e(route('seller.store.index')); ?>">Store Manage</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('seller.banner.index')); ?>">Store banner Manage</a>
                                        </li>
                            ...
                            <li>
                                ...
                                <div class="collapse" id="setting-withdraw">
                                    <ul class="nav-second-level">
                                        <li>
                                            <a href="<?php echo e(route('seller.withdraws')); ?>">My Withdraw</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12 text-end">
                                 &copy; <?php echo e($generalsetting->name); ?> <a href="https://developerekramul.xyz" target="_blank">Ekramul Haque</a> 
                            </div>
                        </div>
                    </div>
                </footer>
...
</html><?php /**PATH G:\xampp\htdocs\pikarihut1\resources\views/frontEnd/seller/pages/master.blade.php ENDPATH**/ ?>