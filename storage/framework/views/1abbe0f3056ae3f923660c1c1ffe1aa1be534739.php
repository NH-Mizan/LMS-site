    ...
    <div id="wrapper">
        ...
        <div class="h-100" data-simplebar>
              ...
              <li>
                  ...
                  <div class="collapse" id="sidebar-seller">
                      <ul class="nav-second-level">
                          ...
                          <li>
                              <a  href="<?php echo e(route('sellers.index',['status'=>'pending'])); ?>">Pending Seller</a>
                          </li>
                          <li>
                              <a  href="<?php echo e(route('sellers.index',['status'=>'inactive'])); ?>">Inactive Seller</a>
                          </li>
                          <li>
                              <a  href="<?php echo e(route('sellers.index',['status'=>'active'])); ?>">Active Seller</a>
                          </li>
                          <li>
                              <a  href="<?php echo e(route('sellers.pending_product')); ?>">Pending Product</a>
                          </li>
                      </ul>
                  </div>
              </li>
          ...
          <li>
              ...
              <div class="collapse" id="sidebar-sellerwithdraw">
                  <ul class="nav-second-level">
                      <li>
                          <a href="<?php echo e(route('admin.ventorwithdraw', 'pending')); ?>">Pending Withdraw</a>
                      </li>
                      <li>
                          <a href="<?php echo e(route('admin.ventorwithdraw', 'paid')); ?>">Paid Withdraw</a>
                      </li>
                      <li>
                          <a href="<?php echo e(route('admin.ventorwithdraw', 'cancel')); ?>">Cancel Withdraw</a>
                      </li>
                  </ul>
              </div>
          </li>
          <!-- nav items -->
              ...
              <li>
                <a href="#sidebar-product-question" data-bs-toggle="collapse">
                  <i data-feather="star"></i>
                  <span> Questions </span>
                  <span class="menu-arrow"></span>
                </a>
                <div class="collapse" id="sidebar-product-question">
                  <ul class="nav-second-level">                   
                    <li>
                      <a href="<?php echo e(route('question.index')); ?>"><i data-feather="file-plus"></i> All Questions</a>
                    </li>
                  </ul>
                </div>
              </li>
              ...
              <li>
                ...
                <div class="collapse" id="siebar-Testimonial">
                  <ul class="nav-second-level">
                    <li>
                      <a href="<?php echo e(route('testimonial.index')); ?>"><i data-feather="file-plus"></i> Testimonial Manage</a>
                    </li>
                  </ul>
              ...
              <li>
                ...
                <div class="collapse" id="siebar-team">
                  <ul class="nav-second-level">
                    <li>
                      <a href="<?php echo e(route('our-team.index')); ?>"><i data-feather="file-plus"></i> Our Team Manage</a>
                    </li>
                  </ul>
              ...
              <li>
                ...
                <div class="collapse" id="siebar-about">
                  <ul class="nav-second-level">
                    <li>
                      <a href="<?php echo e(route('about.index')); ?>"><i data-feather="file-plus"></i> About Manage</a>
                    </li>
                  </ul>
              ...
              <li>
                ...
                <div class="collapse" id="siebar-banner">
                  <ul class="nav-second-level">
                    <li>
                      <a href="<?php echo e(route('banner_category.index')); ?>"><i data-feather="file-plus"></i> Blog Category</a>
                    </li>
                    <li>
                      <a href="<?php echo e(route('banners.index')); ?>"><i data-feather="file-plus"></i> Blog & Ads</a>
                    </li>
                  </ul>
                </div>
              </li>
      ...
      <div class="content-page">
        ...
        <footer class="footer">
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12 text-end"><a href="https://flexzzy.com" target="_blank">Flexzzy</a></div>
            </div>
          </div>
        </footer>
        <!-- end Footer -->
...
<?php /**PATH D:\Xampp\htdocs\aaa\resources\views/backEnd/layouts/master.blade.php ENDPATH**/ ?>