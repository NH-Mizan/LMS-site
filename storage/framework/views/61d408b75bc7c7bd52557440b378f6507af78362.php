...
<?php $__env->startSection('title','Seller Manage'); ?>
                ...
                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php if($value->status=='pending'): ?><span class="badge bg-warning-success text-warning">Pending</span><?php elseif($value->status=='active'): ?><span class="badge bg-soft-success text-success">Active</span><?php else: ?> <span class="badge bg-soft-danger text-danger">Inactive</span> <?php endif; ?></td>
                            <td>
                                <div class="button-list">
                                    <?php if($value->status == 'active'): ?>
                                    <form method="post" action="<?php echo e(route('sellers.inactive')); ?>" class="d-inline"> 
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <?php else: ?>
                                    <form method="post" action="<?php echo e(route('sellers.active')); ?>" class="d-inline">
                                        <?php echo csrf_field(); ?>
                                    <input type="hidden" value="<?php echo e($value->id); ?>" name="hidden_id">        
                                    ...
                                    <?php endif; ?> 
                                    <a href="<?php echo e(route('sellers.edit',$value->id)); ?>" class="btn btn-xs btn-success waves-effect waves-light"><i class="fe-edit-1" title="Edit"></i></a>
                                    <a href="<?php echo e(route('sellers.profile',['id'=>$value->id])); ?>" class="btn btn-xs btn-primary waves-effect waves-light" title="Profile"><i class="fe-eye"></i></a>
                                    <a href="<?php echo e(route('sellers.products',['id'=>$value->id])); ?>" class="btn btn-xs btn-blue waves-effect waves-light" title="Products"><i class="fe-database"></i></a>
                                    <a href="<?php echo e(route('sellers.withdraw',['id'=>$value->id])); ?>" class="btn btn-xs btn-pink waves-effect waves-light" title="Withdraw"><i class="fe-credit-card"></i></a>
...
<!-- third party js ends -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/flexzzyc/public_html/resources/views/backEnd/seller/index.blade.php ENDPATH**/ ?>