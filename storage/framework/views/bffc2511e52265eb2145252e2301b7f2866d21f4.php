...
<html lang="en">
    ...
    (function(c,l,a,r,i,t,y){
        ...
        <link rel="stylesheet" href="<?php echo e(asset('public/frontEnd/css/style.css?v=1.0.5')); ?>" />
        <link rel="stylesheet" href="<?php echo e(asset('public/frontEnd/css/responsive.css?v=1.0.5')); ?>" />
...
})(window,document,'script','dataLayer','GTM-TKC9WG7Q');</script>
<!-- End Google Tag Manager -->
    <body 
  <!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TKC9WG7Q"
...
<!-- End Google Tag Manager (noscript) -->  
    ...
    class="gotop">
        ...
        <header id="navbar_top">
		            ...
		            <div class="top_header" style="background-color:#1D1F20">
                    <div class="container d-flex align-items-center">
                        <!-- Hotline button on the left side -->
                        <a href="tel:<?php echo e($contact->hotline); ?>" class="text-center bg-light px-2 d-none d-sm-block fw-bold fs-4" style="color:#041f3b;min-width:270px;">
                            ...
                            <div class="col-sm-12">
                                <div class="logo-header">
                                    ...
                                    <div class="header-list-items">
                                        <ul>
                                            <li class="track_btn">
                                                <a href="<?php echo e(route('seller.login')); ?>"> <i class="fa-solid fa-person-walking-arrow-right"></i>Become a Seller</a>
                                            </li>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="copyright">
								...
								<p><span style="color: white;">Copyright © <?php echo e(date('Y')); ?> <?php echo e($generalsetting->name); ?>. All rights reserved
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
  ...
  // Bottom থেকে 100px গ্যাপ
  window.Tawk_API.customStyle = {
    visibility: {
      desktop: { position: 'br', xOffset: 24, yOffset: 100 }, // bottom-right
      mobile:  { position: 'br', xOffset: 16, yOffset: 100 }
    }
  };
</script>
...
(function(){
  ...
  s1.async=true;
  s1.src='https://embed.tawk.to/68ae05a311c787192dc3c86c/1j3jsc1v2';
  s1.charset='UTF-8';
...
<?php /**PATH /home/flexzzyc/public_html/resources/views/frontEnd/layouts/master.blade.php ENDPATH**/ ?>