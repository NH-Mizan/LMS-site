...
<head>
 ...
 <title>Seller Register | <?php echo e($generalsetting->name); ?></title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
label.form-check-label.register-center {
    margin-top: 3px;
}
...
<section class="login-section">
  <div class="login-content">
    ...
    <form action="<?php echo e(route('seller.store')); ?>" method="POST" data-parsley-validate="" class="login-form">
         <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" type="text" name="name" id="name" value="<?php echo e(old('name')); ?>" placeholder="Enter shop name" required>
...
unset($__errorArgs, $__bag); ?>" type="text" name="phone" id="phone" value="<?php echo e(old('phone')); ?>" placeholder="Enter phone number" required>
...
unset($__errorArgs, $__bag); ?>" type="email" name="email" id="email" value="<?php echo e(old('email')); ?>" placeholder="Enter email address" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('password')); ?>" placeholder="Enter your password" required>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mb-0">
            <div class="input-group input-group-merge">
                <input type="password" name="confirm-password" id="confirm-password" class="form-control  <?php $__errorArgs = ['confirm-password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('confirm-password')); ?>" placeholder="Confirm password" required>
                <div class="input-group-text" data-password="false">
                    <span class="password-eye"></span>
                </div>
            </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-0">
            <div class="form-check">
                ...
                <label class="form-check-label register-center" for="checkbox-signup">I accept <a href="<?php echo e(route('page',['slug'=>'conditions'])); ?>">Conditions</a> & <a href="<?php echo e(route('page',['slug'=>'privacy-policy'])); ?>">Privacy Policy</a></label>
            </div>
        </div>
...
<?php /**PATH /home/flexzzyc/public_html/resources/views/frontEnd/seller/register.blade.php ENDPATH**/ ?>