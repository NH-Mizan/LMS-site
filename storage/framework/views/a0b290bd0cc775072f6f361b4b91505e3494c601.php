...
<?php $__env->startSection('title','Testimonial Create'); ?>
...
<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <a href="<?php echo e(route('testimonial.index')); ?>" class="btn btn-primary rounded-pill">Manage</a>
                </div>
   ...
   <div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('testimonial.store')); ?>" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                     <div class="col-sm-12">
...
unset($__errorArgs, $__bag); ?>" name="link" value="<?php echo e(old('link')); ?>" id="link" >
...
unset($__errorArgs, $__bag); ?>" name="description" rows="6" value="<?php echo e(old('description')); ?>"  id="description"></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\aaa\resources\views/backEnd/testimonial/create.blade.php ENDPATH**/ ?>