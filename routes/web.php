...
use App\Http\Controllers\Admin\SellerStoreController;
use App\Http\Controllers\Admin\QuitionController;
...
Route::group(['namespace'=>'Frontend', 'middleware' => ['ipcheck','check_refer']], function() {
    ...
    Route::get('our-courses', [FrontendController::class, 'hotdeals'])->name('hotdeals');
   ...
   Route::get('/blog/{slug}', [FrontEndController::class, 'blog_details'])->name('blog.details');
    ...
    Route::get('/english-for-business', [FrontEndController::class, 'english'])->name('english');
...
Route::get('seller/store/{id}', [FrontendController::class, 'sellerStores'])->name('seller.stores');
...
Route::group(['prefix'=>'seller','namespace'=>'Frontend','middleware' => ['seller']], function() {
    ...
    Route::get('/invoice', [SellerController::class, 'invoice'])->name('seller.invoice');
    ...
    // order process sections
    Route::get('order/edit/{invoice_id}', [SellerController::class,'order_edit'])->name('seller.order.edit');
    Route::post('order/update', [SellerController::class,'order_update'])->name('seller.order.update');
    Route::get('order/invoice/{invoice_id}', [SellerController::class,'invoice_order'])->name('seller.order.invoice');
    Route::get('order/process/{invoice_id}', [SellerController::class,'process'])->name('seller.order.process');
    Route::post('order/change', [SellerController::class,'order_process'])->name('seller.order_change');
    Route::get('order-print', [SellerController::class,'order_print'])->name('seller.order.order_print');
    Route::get('silip-print', [SellerController::class,'silip_print'])->name('seller.order.silip_print');

    // Pos route seller
    Route::get('order/create', [SellerController::class,'order_create'])->name('seller.order.create');
    Route::post('order/store', [SellerController::class,'order_store'])->name('seller.order.store');
    Route::get('order/cart-add', [SellerController::class,'cart_add'])->name('seller.order.cart_add');
    Route::get('order/cart-content', [SellerController::class,'cart_content'])->name('seller.order.cart_content');
    Route::get('order/cart-increment', [SellerController::class,'cart_increment'])->name('seller.order.cart_increment');
    Route::get('order/cart-decrement', [SellerController::class,'cart_decrement'])->name('seller.order.cart_decrement');
    Route::get('order/cart-remove', [SellerController::class,'cart_remove'])->name('seller.order.cart_remove');
    Route::get('order/cart-product-discount', [SellerController::class,'product_discount'])->name('seller.order.product_discount');
    Route::get('order/cart-details', [SellerController::class,'cart_details'])->name('seller.order.cart_details');
    Route::get('order/cart-shipping', [SellerController::class,'cart_shipping'])->name('seller.order.cart_shipping');
    Route::post('order/cart-clear', [SellerController::class,'cart_clear'])->name('seller.order.cart_clear');
    ...
    Route::get('products/image/destroys', [SellerProductController::class,'imgdestroy'])->name('seller.products.image.destroy');
});

// Order route 
    Route::get('seller/reviews', [SellerProductController::class,'sellerindex'])->name('seller.reviews.index');
    Route::get('seller/review/pending', [SellerProductController::class,'sellerpending'])->name('seller.reviews.pending');
    Route::post('seller/review/inactive', [SellerProductController::class,'sellerinactive'])->name('seller.reviews.inactive');
    Route::post('seller/review/active', [SellerProductController::class,'selleractive'])->name('seller.reviews.active');
    Route::get('seller/review/create', [SellerProductController::class,'sellercreate'])->name('seller.reviews.create');
    Route::post('seller/review/save', [SellerProductController::class,'sellerstore'])->name('seller.reviews.store');
    Route::get('seller/review/{id}/edit', [SellerProductController::class,'selleredit'])->name('seller.reviews.edit');
    Route::post('seller/review/update', [SellerProductController::class,'sellerupdate'])->name('seller.reviews.update');
    Route::post('seller/review/destroy', [SellerProductController::class,'sellerdestroy'])->name('seller.reviews.destroy');
    
    // seller banner route 
    Route::get('seller/banner/store/', [SellerStoreController::class,'indexBanner'])->name('seller.banner.index');
    Route::post('seller/banner/store/inactive', [SellerStoreController::class,'inactiveBanner'])->name('seller.banner.inactive');
    Route::post('seller/banner/store/active', [SellerStoreController::class,'activeBanner'])->name('seller.banner.active');
    Route::post('seller/banner/store/save', [SellerStoreController::class,'storeBanner'])->name('seller.banner.store');
    Route::get('seller/banner/store/create', [SellerStoreController::class,'createBanner'])->name('seller.banner.create');
    Route::get('seller/banner/store/{id}/edit', [SellerStoreController::class,'editBanner'])->name('seller.banner.edit');
    Route::post('seller/banner/store/update', [SellerStoreController::class,'updateBanner'])->name('seller.banner.update');
    Route::post('seller/banner/store/destroy', [SellerStoreController::class,'destroyBanner'])->name('seller.banner.destroy');

    // seller store route 
    Route::get('seller/store/', [SellerStoreController::class,'index'])->name('seller.store.index');
    Route::post('seller/store/inactive', [SellerStoreController::class,'inactive'])->name('seller.store.inactive');
    Route::post('seller/store/active', [SellerStoreController::class,'active'])->name('seller.store.active');
    Route::post('seller/store/save', [SellerStoreController::class,'store'])->name('seller.store.store');
    Route::get('seller/shop/create', [SellerStoreController::class,'creates'])->name('seller.store.create');
    Route::get('seller/store/{id}/edit', [SellerStoreController::class,'edit'])->name('seller.store.edit');
    Route::post('seller/store/update', [SellerStoreController::class,'update'])->name('seller.store.update');
    Route::post('seller/store/destroy', [SellerStoreController::class,'destroy'])->name('seller.store.destroy');

    // QuitionController route 
    Route::get('question', [SellerProductController::class,'sellerQuestionindex'])->name('seller.question.index');
    Route::post('question/inactive', [SellerProductController::class,'sellerQuestioninactive'])->name('seller.question.inactive');
    Route::post('question/active', [SellerProductController::class,'sellerQuestionactive'])->name('seller.question.active');
    Route::post('question/save', [SellerProductController::class,'sellerQuestionstore'])->name('seller.question.store');
    Route::get('question/{id}/edit', [SellerProductController::class,'sellerQuestionedit'])->name('seller.question.edit');
    Route::post('question/update', [SellerProductController::class,'sellerQuestionupdate'])->name('seller.question.update');
    Route::post('question/destroy', [SellerProductController::class,'sellerQuestiondestroy'])->name('seller.question.destroy');
// =========================seller end========//
Route::group(['prefix'=>'customer','namespace'=>'Frontend', 'middleware' => ['ipcheck','check_refer']], function() {
    ...
    Route::post('/post/question', [CustomerController::class, 'question'])->name('customer.question');
...
Route::group(['namespace'=>'Admin','middleware' => ['auth','lock','check_refer'],'prefix'=>'admin'], function() {
    ...
    // QuitionController route 
    Route::get('question', [QuitionController::class,'index'])->name('question.index');
    Route::post('question/inactive', [QuitionController::class,'inactive'])->name('question.inactive');
    Route::post('question/active', [QuitionController::class,'active'])->name('question.active');
    Route::post('question/save', [QuitionController::class,'store'])->name('question.store');
    Route::get('question/{id}/edit', [QuitionController::class,'edit'])->name('question.edit');
    Route::post('question/update', [QuitionController::class,'update'])->name('question.update');
    Route::post('question/destroy', [QuitionController::class,'destroy'])->name('question.destroy');
