...
class CustomerController extends Controller
{
    ...
    public function review(Request $request){
      ...
      public function question(Request $request){
        ...
        // data save
        $question              =   new Quition();
        $question->name        =   Auth::guard('customer')->user()->name;
        $question->email       =   Auth::guard('customer')->user()->email;
       ...
       Toastr::success('Thanks, Your question send successfully', 'Success!');
       return redirect()->back();
    ...
    public function checkout(){
       ...
       return view('frontEnd.layouts.customer.checkout',compact('bkash_gateway', 'shurjopay_gateway'));
    }
    public function order_save(Request $request){
       ...
       // order details data save
        foreach(Cart::instance('shopping')->content() as $cart){
            ...
            $order_details->pdf             =   $cart->options->pdf;
