...
class DashboardController extends Controller
{
    ...
    public function dashboard(){
        ...
        $courier = Order::where('order_status',5)->count();
        $complete = Order::where('order_status',6)->count();
        $cancel = Order::where('order_status',7)->count();
        ...
        return view('backEnd.admin.dashboard',compact('dates_json','totals_json','pending','courier','cancel','complete','total_order','today_order','total_product','total_customer','latest_order','latest_customer','today_delivery','total_delivery','last_week','last_month','monthly_sale'));
    }
