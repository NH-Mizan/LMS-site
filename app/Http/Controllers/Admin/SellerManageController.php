...
class SellerManageController extends Controller
{
    ...
    public function edit($id){
        ...
        $areas = District::where(['district'=>$edit_data->district])->select('area_name','id')->get();
    ...
    public function profile(Request $request){
        $profile = Seller::with('orders','withdraws')->find($request->id);
        return view('backEnd.seller.profile',compact('profile'));
    }
    public function withdraw(Request $request){
        $data = OrderDetails::where(['seller_id'=>$request->id])->whereHas('order', function ($query) {
    ...
    public function procode_update(Request $request){
        ...
        $update_data->product_code    = $request->proCode;
