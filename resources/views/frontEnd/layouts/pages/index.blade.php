@extends('frontEnd.layouts.master') @section('title', 'Fast, Easy & Secure Online Marketplace')
@push('css')
...
@section('content')
                    ...
                    <div class="post-corporate-gallery post-corporate-gallery-2 inset-1" data-lightgallery="group">
                        <a class="post-corporate-thumbnail post-corporate-thumbnail-1 post-corporate-thumbnail-custom"
                            ...
                            <img class="post-corporate-thumbnail-image"
                                src="{{asset('public/frontEnd/images/group-01-722x490.jpg')}}" alt="" width="722"
                                height="490" /></a>
                        <a class="post-corporate-thumbnail post-corporate-thumbnail-5" href="images/group-02-original.jpg"
                            data-lightgallery="item">
                            <img class="post-corporate-thumbnail-image"
                                src="{{ asset('public/frontEnd/images/group-02-360x326.jpg')}}" alt="" width="360"
                                height="326" /></a>
                        <a class="post-corporate-thumbnail post-corporate-thumbnail-5" href="images/group-03-original.jpg"
                            data-lightgallery="item">
                            <img class="post-corporate-thumbnail-image"
                                src="{{ asset('public/frontEnd/images/group-03-360x326.jpg') }}" alt="" width="360"
                                height="326" /></a>
                    </div>
                </div>
    ...
    <section class="section section-xl context-dark bg-image bg-overlay-1 text-center"
        style="background-image: url({{ asset('public/frontEnd/images/bg-image-3.jpg') }});">
        <div class="container">
                    ...
                    <div class="row row-30 row-md-50 mt-md-45 mt-xxl-70">
                        <div class="col-sm-6 col-lg-12 wow fadeIn" data-wow-delay=".05s">
                            ...
                            <article class="profile-light"><img class="profile-light-image"
                                    src="{{ asset('public/frontEnd/images/home-3-6-95x95.jpg') }}" alt="" width="95"
                                    height="95" />
                        ...
                        <div class="col-sm-6 col-lg-12 wow fadeIn" data-wow-delay=".1s">
                            <!-- Profile Light-->
                            <article class="profile-light"><img class="profile-light-image"
                                    src="{{ asset('public/frontEnd/images/home-3-7-95x95.jpg') }}" alt="" width="95"
                                    height="95" />
                                <div class="profile-light-main">
