                                                    ...
                                                    @if ($productcolors->count() > 0)
                                                        ...
                                                        <div class="store__parts__section mt-4">
                                                            ...
                                                            <div class="store__part2">
                                                                <div class="chat__now__seller"><a href="https://api.whatsapp.com/send?phone=88{{$seller->phone}}"><i class="fa-brands fa-rocketchat"></i> Chat Now</a></div>
                                                            </div>
                                                            <div class="store__part3">
                                                                <a href="{{ route('seller.stores',$seller->slug) }}">GO TO STORE</a>
                                                            </div>
                                                        </div>
                                                        @endif
                                                </form>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8">
                  ...
                  <div class="section-head">
                    <div class="title">
                      <p class="count__question">Questions ({{$question->count()}})</p>
                            ...
                            @foreach ($question as $key => $que)
                                <div class="col-sm-12 col-12">
                                    <div class="review-card">
                                        ...
                                        <p class="review_content">{{ $que->question }}</p>
                                    </div>
                                </div>
                          @if($que->answer !== null)
                      ...
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                           <div class="insert-review">
                                    @if(Auth::guard('customer')->user())
                                    <form action="{{ route('customer.question') }}" id="review-form" method="POST">
                                        @csrf
                                        <input type="hidden" name="product_id" value="{{ $details->id }}">
                                        <input type="hidden" name="seller_id" value="{{ $details->seller_id }}">
                                    ...
                                    @else
                                    <a class="customer-login-redirect" href="{{ route('customer.login') }}">Login to Post Your Question</a>
                                    @endif
                                </div>
                          </div>
                        </div>
