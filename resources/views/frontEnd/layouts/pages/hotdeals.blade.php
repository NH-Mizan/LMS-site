              ...
              <div class="row row-30 row-xl-40">
                <div class="col-sm-6">
                  <article class="tour-classic">
                    <div class="tour-classic-media"><a class="tour-classic-figure" href="english-for-business.html"><img class="tour-classic-image" src="{{ asset('public/frontEnd/images/tour-list-2-1-365x248.jpg') }}" alt="" width="365" height="248"/></a>
                ...
                <div class="col-sm-6">
                  <article class="tour-classic">
                    <div class="tour-classic-media"><a class="tour-classic-figure" href="english-for-business.html"><img class="tour-classic-image" src="{{ asset('public/frontEnd/images/tour-list-2-2-365x248.jpg') }}" alt="" width="365" height="248"/></a>
                      <div class="tour-classic-pricing">
                ...
                <div class="col-sm-6">
                  <article class="tour-classic">
                    <div class="tour-classic-media"><a class="tour-classic-figure" href="english-for-business.html"><img class="tour-classic-image" src="{{ asset('public/frontEnd/images/tour-list-2-3-365x248.jpg') }}" alt="" width="365" height="248"/></a>
                      <div class="tour-classic-pricing">
                ...
                <div class="col-sm-6">
                  <article class="tour-classic">
                    <div class="tour-classic-media"><a class="tour-classic-figure" href="english-for-business.html"><img class="tour-classic-image" src="{{ asset('public/frontEnd/images/tour-list-2-4-365x248.jpg') }}" alt="" width="365" height="248"/></a>
                      <div class="tour-classic-pricing">
