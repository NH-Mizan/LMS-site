...
<section class="login-section">
  <div class="login-content">
    ...
    <form action="{{route('seller.forgot.verify')}}" method="POST" data-parsley-validate="" class="login-form">
        @csrf
      <input type="text" placeholder="Mobile Number" required name="phone" class=" @error('phone') is-invalid @enderror" id="phone" value="{{ old('phone') }}">
       @error('phone')
