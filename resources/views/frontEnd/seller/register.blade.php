...
<section class="login-section">
  <div class="login-content">
    ...
    <form action="{{route('seller.store')}}" method="POST" data-parsley-validate="" class="login-form">
         @csrf
        ...
        <div class="mb-0">
            <div class="form-check">
                ...
                <label class="form-check-label register-center" for="checkbox-signup">I accept <a href="{{route('page',['slug'=>'conditions'])}}">Conditions</a> & <a href="{{route('page',['slug'=>'privacy-policy'])}}">Privacy Policy</a></label>
            </div>
        </div>
