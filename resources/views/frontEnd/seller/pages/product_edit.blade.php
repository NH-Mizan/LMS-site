...
<div class="container-fluid">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('seller.products.update')}}" method="POST" class="row" data-parsley-validate="" enctype="multipart/form-data" name="editForm">
                        @csrf
             ...
             <div class="col-sm-3 mb-3">
              <div class="form-group mb-3">
                ...
                <input type="file" class="form-control @error('pdf') is-invalid @enderror" name="pdf" value="{{ $edit_data->pdf }}" id="pdf" />
                 <a class="btn btn-success" target="_blank" href="{{asset($edit_data->pdf)}}">Show PDF</a>
                @error('pdf')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
