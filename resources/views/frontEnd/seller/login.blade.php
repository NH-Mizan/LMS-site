...
<section class="login-section" id="particles-js">
  <div class="login-content">
    ...
    <form action="{{route('seller.signin')}}" method="POST" data-parsley-validate="" class="login-form">
        @csrf
    <div class="form-group mb-0">
        <div class="input-group input-group-merge">
           <input type="text" placeholder="Email or Mobile Number" required name="phone" class=" @error('phone') is-invalid @enderror" id="phone" value="{{ old('phone') }}">
        </div>
       @error('phone')
  ...
  <div class="form-group mb-0">
    <div class="input-group input-group-merge">
      ...
      <div class="form-links">
        <a href="{{route('seller.forgot.password')}}">Reset password</a> |
        <a href="{{route('seller.register')}}">Create a new account</a>
