            ...
            <div class="col-sm-12 mt-3">
                <div class="invoice-innter" style="width:760px;margin: 0 auto;background: #fff;overflow: hidden;padding: 30px;padding-top: 0;">
                    <table style="width:100%">
                        <tr>
                            <td style="width: 40%; float: left; padding-top: 15px;">
                                <img src="{{asset($generalsetting->dark_logo)}}" width="190px" style="margin-top:25px !important" alt="">
                                <p style="font-size: 14px; color: #222; margin: 20px 0 0;"><strong>Payment Method:</strong> <span style="text-transform: uppercase;">{{$order->payment?$order->payment->payment_method:''}}</span></p>

                                <p style="font-size: 14px; color: #222; margin: 0px 0 10px;"><strong>Shop Name:</strong> <span style="text-transform: uppercase;">{{$order->shop?$order->shop->name:''}}</span></p>
                            ...
                            <td  style="width:60%;float: left;">
                                <div class="invoice-bar" style=" background: #01ADEF; transform: skew(38deg); width: 100%; margin-left: 65px; padding: 20px 60px; ">
                    ...
                    <table class="table" style="margin-top: 30px;margin-bottom: 0;">
                        <thead style="background: #01ADEF; color: #fff;">
                            <tr>
                                <th>SL</th>
                                <th>Product</th>
                                <th>Price</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span style="background-color: {{ $value->product_color }}; width: 25px; height: 25px; display: block; margin: 5px auto; border-radius: 2px;"></span>
                                    <p style="text-align:center;">{{$value->product_color}}</p>
                                    @endif
                    ...
                    <div class="invoice-bottom">
                        ...
                        <table class="table" style="width: 300px; float: right;    margin-bottom: 30px;">
                            <tbody style="background:#f1f9f8">
                                ...
                                <tr style="background:#01ADEF;color:#fff">
                        ...
                        <div class="terms-condition" style="overflow: hidden; width: 100%; text-align: center; padding: 20px 0; border-top: 1px solid #ddd;">
                            <h5 style="font-style: italic;"><a href="{{route('page',['slug'=>'terms-condition'])}}">Terms & Conditions : Available service wareenty 60 Days</a></h5>
                            <p style="text-align: center; font-style: italic; font-size: 15px; margin-top: 10px;">* Thanks for choose, Made by <strong style="color:red;">Quikaro</strong> Made by world</p>
                        </div>
                    </div>
                </div>
            </div>
