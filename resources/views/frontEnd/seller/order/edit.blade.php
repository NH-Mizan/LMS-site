...
<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                   {{-- <form method="post" action="{{route('seller.order.cart_clear')}}" class="d-inline">
                        @csrf
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('seller.order.update')}}" method="POST" class="row pos_form" data-parsley-validate="" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="col-sm-6">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group mb-2">
                                        <input type="hidden" id="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="Customer Number" name="phone" value="{{$shippinginfo->phone}}"  required>
                                        @error('phone')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
...
<script>
    function cart_content(){
           $.ajax({
             type:"GET",
             url:"{{route('seller.order.cart_content')}}",
             dataType: "html",
      ...
      function cart_details(){
           $.ajax({
             type:"GET",
             url:"{{route('seller.order.cart_details')}}",
             dataType: "html",
             success: function(cartinfo){
      ...
      $('#cart_add').on('change',function(e){
       var id =$(this).val();
        if(id){
            ...
            type:"GET",
            data:{'id':id},
            url:"{{route('seller.order.cart_add')}}",
            dataType: "json",
            success: function(cartinfo){
    ...
    $(".cart_increment").click(function(e){
        ...
        if(id){
              $.ajax({
               ...
               data:{'id':id,'qty':qty},
               type:"GET",
               url:"{{route('seller.order.cart_increment')}}",
               dataType: "json",
            success: function(cartinfo){
                return cart_content()+cart_details();
            }
    ...
    $(".cart_decrement").click(function(e){
        ...
        if(id){
              $.ajax({
               ...
               type:"GET",
               data:{'id':id,'qty':qty},
               url:"{{route('seller.order.cart_decrement')}}",
               dataType: "json",
            success: function(cartinfo){
                return cart_content()+cart_details();
            }
    ...
    $(".cart_remove").click(function(e){
        ...
        if(id){
              $.ajax({
               ...
               type:"GET",
               data:{'id':id},
               url:"{{route('seller.order.cart_remove')}}",
               dataType: "json",
              success: function(cartinfo){
                return cart_content()+cart_details();
            }
   ...
   $(".product_discount").change(function(){
        ...
        var discount = $(this).val();
          $.ajax({
           ...
           url:"{{route('seller.order.product_discount')}}",
           dataType: "json",
          success: function(cartinfo){
            return cart_content()+cart_details();
          }
    ...
    $(".cartclear").click(function(e){
      $.ajax({
           cache: false,
           type:"GET",
           url:"{{route('seller.order.cart_clear')}}",
           dataType: "json",
          success: function(cartinfo){
            return cart_content()+cart_details();
          }
    ...
    $("#area").on("change", function () {
        ...
        $.ajax({
            type: "GET",
            data: { id: id },
            url: "{{route('seller.order.cart_shipping')}}",
            dataType: "html",
            success: function(cartinfo){
               return cart_content()+cart_details();
            }
