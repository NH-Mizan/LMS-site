...
<body>
  <header class="header">
    <div class="logo">
      Quikaro Seller Verify
    </div>
    <nav>
      <ul class="nav-list">
        <li><a href="{{route('home')}}">Go To Home</a></li>
      </ul>
    </nav>
  </header>
<section class="login-section">
  <div class="login-content">
    <img src="{{asset('public/frontEnd/images/main-logo.png')}}" alt="">
    <h1>Become A Quikaro Seller Today!</h1>
    <p>Create a Quikaro seller account now and reach millions of customers!</p>
    <form action="{{route('seller.forgot.store')}}" method="POST" data-parsley-validate="" class="login-form">
        @csrf
      <input type="text" placeholder="Enter OTP" required name="otp" class=" @error('otp') is-invalid @enderror" id="otp" value="{{ old('otp') }}">
       @error('otp')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        @enderror
      <input type="password" placeholder="Entwe New Password" required name="password" class=" @error('password') is-invalid @enderror" id="password" value="{{ old('password') }}">
       @error('phone')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
 ...
 <section class="join__sellers">
   <div class="features-container">
     <div class="data_join_seller">
        <h3>Join the Quikaro Seller Community</h3>
        <p class="mb-3">
          Welcome to Quikaro, your premier destination for fast and reliable online shopping. We are excited to invite you to become a part of our growing seller community. By partnering with Quikaro, you can expand your business reach, connect with a diverse customer base, and boost your sales.
        </p>
        ...
        <p class="mb-3">
          ...
          <p class="mb-3">
            ...
            <p class="mb-3">
              ...
              Join Quikaro today and take your business to new heights by reaching customers nationwide.
...
<section class="join__sellers">
   <div class="features-container">
     <div class="data_join_seller">
        <h2>Join the Quikaro Seller Program</h2>
        <p class="mb-3">
         Welcome to Quikaro, the ultimate multi-vendor eCommerce platform where entrepreneurs like you can showcase products, connect with customers, and grow your business. Our seller-friendly marketplace offers all the tools and support you need to succeed in the competitive online space.
        </p>
        <h3 class="mt-3">Why Sell on Quikaro?</h3>
        <p class="mb-3">
...
<section class="steps-section">
  ...
  <div class="features-container">
    <div class="step">
      ...
      <h3>Sign Up</h3>
      <p>Register your seller account on Quikaro in just a few easy steps.</p>
    </div>
...
<section class="join__sellers">
   <div class="features-container">
     <div class="data_join_seller">
        <h2>What You Can Sell on Quikaro</h2>
        <p class="mb-3">
         From fashion and electronics to handmade crafts and more, Quikaro allows you to list a wide range of products. With category-specific tools and features, you can optimize your product visibility and appeal to the right audience.
        </p>
        ...
        <p class="mb-3">
         Quikaro is more than a marketplace—it’s a thriving community of entrepreneurs and innovators. Whether you're just starting or an established business, we offer the resources and exposure you need to grow.
        </p>

        <h3 class="mt-3">Ready to Get Started?</h3>
        <p class="mb-3">
        Take the first step toward building a successful online business. Click the button below to register as a seller on Quikaro today!
        </p>
...
<section class="faq-section">
  ...
  <div class="faq-container">
    <div class="faq-item">
      <h3>How Can I Sell On Quikaro?</h3>
      <p>To start selling on Quikaro, visit the Quikaro Seller Center and create a new account using your phone number. Complete the sign-up process by verifying your email, adding your pickup address, and uploading the required documents for verification. Once your store is approved, you can start listing your products!</p>
    </div>

    <div class="faq-item">
      <h3>What Categories Can I Sell on Quikaro?</h3>
      <p>With multiple categories on Quikaro—ranging from fashion, lifestyle, digital goods, FMCG, and lifestyle—you’ll find the perfect fit for your products. However, it’s essential to avoid listing counterfeits, dangerous, or prohibited items as per our cultural norms.</p>
    </div>

    <div class="faq-item">
      <h3>How Much Commission Does Quikaro Charge?</h3>
      <p>Opening a shop on Quikaro is free! However, a small commission is deducted from each order’s payment, with rates varying based on the product category. You can find more details about commissions in different categories here.</p>
    </div>

    <div class="faq-item">
      <h3>What is the Payment Policy of Quikaro?</h3>
...
<section class="cta-section">
  <div class="cta-container">
    <h2>Ready to Start Selling on Quikaro?</h2>
    ...
    <a href="https://www.Quikaro.com.bd/seller-center" class="cta-button">Start Selling Now</a>
  </div>
</section>
