              ...
              <li>
                  ...
                  <div class="collapse" id="sidebar-seller">
                      <ul class="nav-second-level">
                          ...
                          <li>
                              <a  href="{{route('sellers.index',['status'=>'pending'])}}">Pending Seller</a>
                          </li>
                          <li>
                              <a  href="{{route('sellers.index',['status'=>'inactive'])}}">Inactive Seller</a>
                          </li>
                          <li>
          ...
          <!-- nav items -->
              ...
              <li>
                ...
                <div class="collapse" id="sidebar-product-question">
                  <ul class="nav-second-level">                   
                    <li>
                      <a href="{{route('question.index')}}"><i data-feather="file-plus"></i> All Questions</a>
                    </li>
                  </ul>
                </div>
              </li>
              ...
              <li>
                ...
                <div class="collapse" id="siebar-about">
                  <ul class="nav-second-level">
                    <li>
                      <a href="{{route('about.index')}}"><i data-feather="file-plus"></i> About Manage</a>
                    </li>
                  </ul>
              ...
              <li>
                ...
                <div class="collapse" id="siebar-gallery">
                  <ul class="nav-second-level">
                    <li>
                      <a href="{{route('gallery.index')}}"><i data-feather="file-plus"></i> Gallery Manage</a>
                    </li>
                  </ul>
              ...
              <li>
                ...
                <div class="collapse" id="siebar-banner">
                  <ul class="nav-second-level">
                    <li>
                      <a href="{{route('banner_category.index')}}"><i data-feather="file-plus"></i> Blog Category</a>
                    </li>
                    <li>
                      <a href="{{route('banners.index')}}"><i data-feather="file-plus"></i> Blog & Ads</a>
                    </li>
                  </ul>
                </div>
              </li>
