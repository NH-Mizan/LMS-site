                ...
                <form action="{{route('products.procode.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('proCode') is-invalid @enderror" name="proCode" value="{{ $edit_data->proCode }}" id="proCode" required>
                            @error('proCode')
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('proCommission') is-invalid @enderror" name="proCommission" value="{{ $edit_data->proCommission }}" id="proCommission" required>
                            @error('proCommission')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
